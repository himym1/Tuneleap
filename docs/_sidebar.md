...
- [开发环境搭建](development-guide.md)

- **功能特性**
  - [功能总览](features/README.md)
  - [Phase 1: 能听](features/phase1-playback.md)
  - [Phase 2: 好用](features/phase2-usability.md)
  - [Phase 3: 好看](features/phase3-polish.md)
  - [Phase 4: 完善](features/phase4-advanced.md)
  - [PC 端功能文档](navidrome-player-prd-pc.md)
  - [移动端功能文档](navidrome-player-prd-mobile.md)
  - [完整功能文档 PRD（统一版）](navidrome-player-prd.md)

- **服务适配**
  - [Subsonic API 参考](services/subsonic-api.md)

- **开发指南**
  - [Subsonic API 使用](guides/subsonic-api.md)
  - [状态管理](guides/state-management.md)
...
- **设计稿**
  - [Pencil 管理](designs/pencil/README.md)
